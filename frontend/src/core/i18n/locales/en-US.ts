...
export const enUS: Translations = {
  ...
  knowledge: {
    ...
    threadKb: "Knowledge Bases",
    threadKbDescription: "Bind knowledge bases to this conversation",
    boundKbs: "Bound",
    availableKbs: "Available",
    bind: "Bind",
    unbind: "Unbind",
    noAvailableKbs: "No knowledge bases available",
    noBoundKbs: "No knowledge bases bound",
    bindSuccess: "Knowledge base bound",
    unbindSuccess: "Knowledge base unbound",
    bindFailed: "Failed to bind knowledge base",
    unbindFailed: "Failed to unbind knowledge base",
    mentionKb: "Mention a knowledge base",
  },
