"""ChannelManager — consumes inbound messages and dispatches them to the Allo agent via LangGraph Server."""
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the Allo agent.
