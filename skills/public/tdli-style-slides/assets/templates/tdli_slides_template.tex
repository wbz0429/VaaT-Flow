...
\newif\ifShowPhoto
\ShowPhotofalse   % Change to \ShowPhototrue and add your own assets/me.jpg to enable photo
...
\setbeamertemplate{headline}{%
  \ifbeamer@plainframe\else
    \vbox to 0pt{%
      \vss
      \hbox to \paperwidth{%
        \hss\includegraphics[width=\paperwidth]{assets/页眉newstyle.png}\hss
      }%
    }%
    \vspace{0.93cm}%
  \fi
...
\setbeamertemplate{footline}{%
  \ifbeamer@plainframe\else
    \vbox to 0.71cm{%
      \vfill
      \hbox to \paperwidth{%
        \hss\includegraphics[width=\paperwidth]{assets/页脚.png}\hss
      }%
    }%
  \fi
}
...
\centering
\vspace{-1.2cm}
% Add your own photo at assets/me.jpg if photo display is enabled
\end{column}
